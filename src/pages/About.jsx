          ...
          <div className='main'>
            ...
            <div className='aboutMe'>
              ...
              <div className='aboutInfo'>
                <p>Tenho 27 anos, resido em São Carlos no interior de São Paulo, sou apaixonado por tecnologia, viagens e esportes.<br/> Sou desenvolvedor Web Front-End em processo de transição de carreira, venho da área metal-mecânica onde eu exercia a função de técnico mecânico/Projetista.<br/> Hoje curso Engenharia de Software na universidade Estácio de Sá e Desenvolvimento Web full-stack na escola de programação Trybe.<br/> Durante a minha formação na Trybe pude desenvolver diversos projetos individuais e em grupo, onde aprendi e desenvolvi habilidades de hard skills com as seguintes tecnologias: HTML, CSS, JavaScript, BootStrap, Node, React, Redux, ReactTestLibary e Figma, além de soft skills como comunicação, trabalho em equipe e inteligência emocional.</p>
              </div>
            </div>
          </div>
        </div>
